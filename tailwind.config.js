    ...
    extend: {
      colors: {
        ...
        border: {
          ...
          'dark-default': 'rgba(255,255,255,0.12)',
          'dark-strong': 'rgba(255,255,255,0.20)',
        },
        semantic: {
          success: {
            50: '#F0FDF4',
      ...
      fontFamily: {
        heading: ['Playfair Display Variable', 'ui-serif', 'Georgia', 'serif'],
        body: ['Inter Variable', 'system-ui', '-apple-system', 'sans-serif'],
        display: ['Playfair Display Variable', 'ui-serif', 'Georgia', 'serif'],
